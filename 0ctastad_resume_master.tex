...
\documentclass[10pt,letter,sans]{moderncv/moderncv}
...
\section{Skills}
\cvitem{Languages}{\textsc{r}, \textsc{sql}, \textsc{xml}, \textsc{html}, \textsc{css}, \textrm{\LaTeX}}
\cvitem{Platforms}{Linux, \textsc{git}, \textsc{nginx}, \textsc{apache}, Relational Databases, Oracle, Rstudio, Vim, MS Office, LibreOffice}
\cvitem{Packages}{rmarkdown, shiny, ggplot2, dplyr, tidyr, tibble, readr, purrr, BioC}
...
\cvitem{Languages}{\textsc{R}, \textrm{\LaTeX}, \textsc{sql}, \textsc{bash}, \textsc{html}, \textsc{css}, \textsc{xml}}
...
\cventry{May 2019 --- Present}{Department of Department of OBGYN}{Graduate Research Assistant}{Minneapolis, MN}{Starr Lab}{%
    \begin{itemize}
        \item{}
        \item{}
        \item{}
