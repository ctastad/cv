...
\cventry{May 2019 --- Present}{Department of OBGYN}{Graduate Research Assistant}{Minneapolis, MN}{Starr Lab}{%
    \begin{itemize}
        \item{Conducted full stack rewrite of cancer gene web app; implementing new framework, dramatically reducing code base, and eliminating need for SQL database.}
        \item{}
        \item{}
\end{itemize}}
