...
\cvitem{Platforms}{Linux, git, \textsc{nginx}, \textsc{apache}, HPC, virtualization, docker, Relational Databases, Oracle, wordpress}
...
\cventry{Oct 2017 --- Oct 2018}{United Parcel Service}{Supervisor}{Minneapolis, MN}{Small Sort}{%
    \begin{itemize}
        ...
        \item{Developed never-before-seen improvement projects leading to missort elimination and training with disability access.}
\end{itemize}}
