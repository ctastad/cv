...
\cvitem{Statistics}{Hypothesis testing, Simple/Multiple/Poisson Regression, A/B Testing, Contingency Testing, ANOVA, Survival Analysis, K-means, PCA, K-nearest neighbor, SVM, Bayesian Networks, Functional Linkage Networks}
...
% load planner
\cventry{Oct 2018 --- Present}{United Parcel Service}{Load Planning Engineer}{Minneapolis, MN}{Industrial Engineering}{%
    \begin{itemize}
...
\cventry{Dec 2007 --- Jan 2013}{The Stem Cell Institute}{Research Associate}{Minneapolis, MN}{Asakura Lab}{%
    \begin{itemize}
        ...
        \item{Authored significant writing efforts for group manuscripts and major grant awards, including a sucessful R01 bid.}
\end{itemize}}
