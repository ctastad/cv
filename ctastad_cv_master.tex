...
\cventry{May 2019 --- Present}{Department of OBGYN}{Graduate Research Assistant}{Minneapolis, MN}{Starr Lab}{%
    \begin{itemize}
        ...
        \item{Conducted Bioinformatic research into copy number variation within the Ovarian Cancer Precision Medicine Initiative dataset.}
...
\cventry{Oct 2018 --- Present}{United Parcel Service}{Load Planning Engineer}{Minneapolis, MN}{Industrial Engineering}{%
    \begin{itemize}
        \item{Primary authority in coordinating all hub-wide load related functions; mediating hub, feeder, and engineering priorities.}
