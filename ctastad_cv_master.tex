...
% ATS work around
\newcommand{\atsWorkAround}{{\fontsize{0.1}{0}\selectfont \transparent{0}{}}}
...
\cventry{May 2019 --- Present}{Department of OBGYN}{Graduate Research Assistant}{Minneapolis, MN}{Starr Lab}{%
    \begin{itemize}
        ...
        \item{Developed full raw data to figure pipeline to automate analysis process, incorporating a modified HMM and FastCall algorithms.}
        \item{Leveraged comprehensive statistical and computational approach to study whole exome and single cell sequencing cancer data.}
\end{itemize}}
