...
\newcommand{\company}{NovuHealth}
\newcommand{\role}{ETL Engineer}
...
%\title{Letter}
%\recipient{HR Department}{\company{} \\ 5401 Gamble Drive, Suite 300 \\ Minneapolis, MN 55416}
%\date{\today}
...
\cventry{Dec 2019}{University of Minnesota}{Bioinformatics, MS}{Minneapolis, MN}{Bioinformatics and Computational Biology}{Capstone: Copy number variation in ovarian cancer from single cell and whole exome sequencing data.}
\cventry{May 2011}{University of Minnesota}{Biochemistry, BS}{Minneapolis, MN}{College of Biological Sciences}{}
...
\cventry{May 2019 --- Present}{University of Minnesota Dept.\ of OBGYN}{Computational Biologist}{Minneapolis, MN}{Starr Lab}{%
    \begin{itemize}
        \item{Executed full rewrite of cancer gene web app: deployed new framework, reduced codebase, removed need for SQL database.}
