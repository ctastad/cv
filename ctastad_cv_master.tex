...
\cvitem{Platforms}{Linux (Ubuntu, RHEL, CentOS), git, Nginx, Apache, HPC, AWS, Docker, Oracle, WordPress}

\cvitem{Packages}{rmarkdown, shiny, ggplot2, dplyr, jsonlite, DT}

\cvitem{Genomics}{samtools, bwa-mem, bedtools, Seurat, VarScan2, Excavator, DNAcopy, parallel, SummarizedExperiment}
